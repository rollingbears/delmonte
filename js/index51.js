...
$(function(){
	...
	$("#quick_btn").on("click", function(){
		if($("#quick_menu").css("display")=="none"){
			$("#quick_btnimg").attr("src","img/side_btn3.png")
		}
		else if($("#quick_menu").css("display")=="block"){
			$("#quick_btnimg").attr("src","img/side_btn4.png") 
		}
	...
	var asideButton= $(".page-main aside").find("button");
	...
	$(asideButton).click(function(){
		...
		if(aside.hasClass("open")){
			aside.stop().animate({right: '0px'}, duration, 'easeOutQuad');
			asideButton.find('img').attr('src','./img/btn_close1.png');
			
		}else{
			aside.stop().animate({right: '-185px'}, duration, 'easeOutQuad');//easeOutBack
			
			asideButton.find('img').attr('src','./img/btn_open1.png');
	...
	if($.cookie("pop")!="no")$("pop_wrap").fadeIn("slow");
